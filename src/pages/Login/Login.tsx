        ...
        <div className="mt-[50px] flex flex-col items-center w-full lg:w-fit gap-[11.47px] lg:gap-[17.75px]">
          ...
          <div className="relative flex items-center w-[90%] lg:w-[526px]">
            <input 
              ...
              className="w-full h-[38.43px] lg:h-[59.22px] bg-[#F2F2F2] rounded-[22.6049px] lg:rounded-[34.8344px] text-[#8BA2B1] text-[13.9036px] lg:text-[21.4257px] leading-[21px] lg:leading-[32px] font-[400] font-light pl-[18.7px] lg:pl-[28.9px] outline-none ring-0" 
              placeholder="Submit password" 
            />
            {
              !paswordShow ? 
                <svg onClick={showPasswordHandler} xmlns="http://www.w3.org/2000/svg" fill="#000" className="bi bi-eye-slash w-[15px] lg:w-[20px] absolute right-[10px] cursor-pointer opacity-40" viewBox="0 0 16 16">
          ...
          <Link to='/' className="w-full cursor-pointer mt-[20px]">
