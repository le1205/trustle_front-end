    ...
    <div>
      <section className="flex justify-center flex-col items-center">
        ...
        <div className="mt-[48px] flex flex-col lg:flex-row w-[90%] lg:w-fit">
          <button className="w-full lg:w-[265px] h-[59px] bg-[#F2F2F2] rounded-[50px] text-primary text-[20px] leading-[30px] font-[700] font-extraBold">Sign up</button>
          <button className="w-full lg:w-[265px] h-[59px] bg-[#5f8fe6] rounded-[50px] text-white text-[20px] leading-[30px] font-[700] font-extraBold ml-[2px] mt-[20px] lg:mt-0">Log in</button>
        </div>
      </section>
    </div>
  )
