      ...
      <div className="flex justify-center flex-col items-center">
        ...
        <div className="mt-[31.8px] lg:mt-[49px] flex flex-col items-center w-full lg:w-fit gap-[11.54px] lg:gap-[17.78px]">
          ...
          <div className="relative flex items-center w-[90%] lg:w-[526px]">
            <input type='pasword' className="w-full h-[38.43px] lg:h-[59.22px] bg-[#F2F2F2] rounded-[22.6049px] lg:rounded-[34.8344px] text-[#8BA2B1] text-[13.9036px] lg:text-[21.4257px] leading-[21px] lg:leading-[32px] font-[400] font-light pl-[18.7px] lg:pl-[28.9px] outline-none ring-0" placeholder="Submit password" />
            <svg xmlns="http://www.w3.org/2000/svg" fill="#8BA2B1" className="bi bi-eye w-[15px] lg:w-[20px] absolute right-2 lg:right-3 cursor-pointer" viewBox="0 0 16 16">
