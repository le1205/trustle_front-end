    ...
    <section className="pl-[42px] pr-[24px] lg:px-[128px] flex justify-center mb-[30px]">
      <div className="max-w-[1440px] w-full">
        ...
        <div className="pl-0 lg:pl-[14px] mt-[10px]">
          <p className="text-black text-[19.35px] lg:text-[24.7907px] font-[400] leading-[29px] lg:leading-[37px] font-regular">Physical cash, telephone subscriptions, and touchscreens - are all highly medieval tech-solutions to great products that allow us to move and communicate freely with each-other. Through scientific research, Trustle is approaching hardware with new eyes and redefining the consumer needs from the ground up.</p>          
