  ...
  return (
    <div className="w-full">
      <div className="grid grid-cols-5 items-center">
        <div className="col-span-2 flex items-end flex-col cursor-pointer" onClick={(e) => handleNavigate(e, "/will")}>
        ...
        <div className="col-span-2 flex items-end justify-start lg:justify-center cursor-pointer" onClick={(e) => handleNavigate(e, "/will")}>
      ...
      <div className="grid grid-cols-5 mt-[53px] lg:mt-[75px] items-center">
        <div className="col-span-2 flex items-end flex-col cursor-pointer" onClick={(e) => handleNavigate(e, "/memorial")}>
        ...
        <div className="col-span-1"></div>
        <div className="col-span-2 flex items-end justify-start lg:justify-center cursor-pointer" onClick={(e) => handleNavigate(e, "/memorial")}>
          <img src="/images/memorial.svg" className="w-[62.05px] lg:w-[86.74px] ml-[12.23px] lg:ml-0" alt="memorial" />
        </div>
      </div>
      <div className="grid grid-cols-5 mt-[53px] lg:mt-[75px] items-center">
        <div className="col-span-2 flex items-end flex-col cursor-pointer" onClick={(e) => handleNavigate(e, "/city")}>
        ...
        <div className="col-span-1"></div>
        <div className="col-span-2 flex items-end justify-start lg:justify-center cursor-pointer" onClick={(e) => handleNavigate(e, "/city")}>
          <img src="/images/city.svg" className="w-[68.6px] lg:w-[95.9px] ml-[8.88px] lg:ml-0" alt="city" />
        </div>
      </div>
      <div className="grid grid-cols-5 mt-[53px] lg:mt-[75px] items-center">
        <div className="col-span-2 flex items-end flex-col cursor-pointer" onClick={(e) => handleNavigate(e, "/hardware")}>
        ...
        <div className="col-span-1"></div>
        <div className="col-span-2 flex items-end justify-start lg:justify-center cursor-pointer" onClick={(e) => handleNavigate(e, "/hardware")}>
